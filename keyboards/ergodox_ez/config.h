...
#define SERIAL_SOFT_TXD_DDR         DDRE
#define SERIAL_SOFT_TXD_PORT        PORTE
#define SERIAL_SOFT_TXD_PIN         PINE
#define SERIAL_SOFT_TXD_BIT         6

...
[BASE] = LAYOUT_ergodox_flip_pretty(
  ...
  KC_LSPO,          KC_Z,             KC_X,             KC_C,             KC_V,             KC_B,             KC_LALT,          /* | */             _,                KC_N,             KC_M,             KC_COMMA,         KC_DOT,           KC_SLASH,         KC_RPRN,
...
[SYMB] = LAYOUT_ergodox_flip_pretty(
  ...
  KC_TRNS,          _,                _,                KC_CIRC,          KC_DLR,           _,                _,                /* | */             KC_BRMU,          _,                KC_MINS,          KC_PLUS,          KC_DQUO,          LSFT(KC_P),       _,
  KC_TRNS,          KC_LPRN,          KC_RPRN,          KC_LCBR,          KC_RCBR,          _,                                  /* | */                               KC_EQL,           KC_LBRC,          KC_RBRC,          KC_QUOTE,         KC_P,             _,

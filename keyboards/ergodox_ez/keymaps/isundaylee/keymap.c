...
[NUMS] = LAYOUT_ergodox_flip_pretty(
  _,                _,                _,                _,                _,                _,                _,                _,                _,                _,                _,                KC_KP_SLASH,      KC_KP_ASTERISK,   _,    
  ...
  _,                KC_KP_ENTER,      KC_KP_DOT,        KC_KP_0,          KC_KP_0,                                                                                  KC_KP_0,          KC_KP_0,          KC_KP_DOT,        KC_KP_ENTER,      _,    
